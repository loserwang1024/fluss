...
import com.alibaba.fluss.server.zk.data.ZkData.ResourceNode;
...
public class ZooKeeperClient implements AutoCloseable {
    ...
    public Optional<ResourceAcl> getResourceAcl(Resource resource) throws Exception {
        String path = ResourceNode.path(resource);
        return getOrEmpty(path).map(ResourceNode::decode);
    }
    ...
    public List<String> listResourcesByType(ResourceType resourceType) throws Exception {
        String path = ResourceNode.path(resourceType);
