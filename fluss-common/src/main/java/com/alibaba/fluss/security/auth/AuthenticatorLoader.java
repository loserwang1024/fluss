...
public class AuthenticatorLoader {
    ...
    public static Supplier<ClientAuthenticator> loadClientAuthenticatorSupplier(
        ...
        AuthenticationPlugin authenticatorPlugin =
                discoverPlugin(configuration, clientAuthenticateProtocol);
    ...
    public static Map<String, Supplier<ServerAuthenticator>> loadServerAuthenticatorSuppliers(
        ...
        for (Endpoint endpoint : endpoints) {
            ...
            AuthenticationPlugin serverAuthenticatorPlugin =
                    discoverPlugin(configuration, serverAuthenticateProtocol);
     ...
     *     interface.
     */
    private static AuthenticationPlugin discoverPlugin(
            Configuration configuration, String protocol) {
        ...
        List<AuthenticationPlugin> matchingPlugins = new ArrayList<>();
